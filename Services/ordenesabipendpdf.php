...
class MYPDF extends TCPDF {
    ...
    <td align="center" bgcolor="#808B96" width="60">Etiq</td>
    <td align="center" bgcolor="#808B96" width="60">R.Est</td>
    <td align="center" bgcolor="#808B96" width="60">Cap</td>
    <td align="center" bgcolor="#808B96" width="60">Imp</td>
    <td align="center" bgcolor="#808B96" width="60">Rece</td>
    <td align="center" bgcolor="#808B96" width="60">Email</td></tr></table><br>', false, 0);
...
*/
      ...
      <td align="left" width="500" >Fecha Cap.: '.$rg[fecha].' '.$rg[hora].' '.$Rec.' '. $Urgencia.' &nbsp;Fech/hra entega: '.$rg[fechae].' '.$rg[horae].'</td>
      </tr></table>';
   ...
   /*   
    ...
    <td align="left"  width="225">'.$fechatn.' &nbsp; &nbsp;'.$horatn.' &nbsp; &nbsp;'.$rg[usrest].' &nbsp; &nbsp;'.$rg[statustom].' &nbsp;
    '.RestarHoras($horaini,$horafin).'</td>
    <td align="center"><img src="images/'.$imagen1.'">'.$imagen1.'</a></td>
    <td align="center"><img src="images/'.$imagen2.'">'.$imagen2.'</a></td>
    <td align="center"><img src="images/'.$imagen3.'">'.$imagen3.'</a></td>
    <td align="center"><img src="images/'.$imagen4.'">'.$imagen4.'</a></td>
    <td align="center"><img src="images/'.$imagen5.'">'.$imagen5.'</a></td>
    </tr>
    </table>';
