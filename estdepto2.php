...
if (isset($_REQUEST["filtro"])){
    $_SESSION['OnToy'][11] = $_REQUEST["filtro"];    
}else{
    $_SESSION['OnToy'][11] = '*';    
}
            ...
            <table>
                <tr>
                    <td class="letrap">
                        ...
                        echo "$Gfont <font size='1'>Status</font>";

                        echo "<select size='1' name='filtro' class='letrap' onChange='frmfiltro.submit();'>";
                        echo "<option value='*'>Todos*</option>";  
