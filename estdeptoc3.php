...
if ($_REQUEST[Boton] == "Guardar") {  //Guarda el Movto de Notas
    ...
    $lUp = mysql_query("UPDATE otd SET texto = '$_REQUEST[Texto]', status='CAPTURA',
     		 medico = '$_REQUEST[Medico]',tres = '$Fechaest', lugar='4', fechaest = '$Fechaest', statustom = 'TOMA/REALIZ',capturo='$Gusr'
    ...
    $Msj='Interpretación Guardada con Exito';

    AgregaBitacoraEventos2($Gusr, '/Interpretacion/Interpretacion de Estudio', "otd", $Fechaest, $busca, $Msj, "estdeptoc3.php");

}elseif($_REQUEST[Boton] == "Validar"){

    $Up = mysql_query("UPDATE otd SET fechavalida='$Fechaest', status='TERMINADA', usrvalida='$Gusr' WHERE orden='$busca' and estudio='$estudio'");
    ...
    $Msj='Interpretación Validada con Exito';

    AgregaBitacoraEventos2($Gusr, '/Interpretacion/Validacion de Estudio', "otd", $Fechaest, $busca, $Msj, "estdeptoc3.php");
...
$OtA = mysql_query("SELECT ot.fecha,ot.hora,ot.fechae,ot.horae,ot.servicio,ot.cliente,ot.medico,ot.diagmedico,ot.observaciones,
    ...
    otd.medico as medicores,otd.texto2, ot.institucion, ot.suc, ot.recepcionista, ot.medicon, otd.capturo, otd.status
    ...
    <table width="97%" border="0" align="center">
        ...
        <tr  class="letrap">
            <td align="center">
                ...
                <input style='color: #000000; background-color: #7FB3D5' class='letrap' type='submit' name='Boton' value='Guardar'></input>

                <?php
                if ($Ot[capturo] <> '') {

                    if ($Ot[status] == 'TERMINADA') {
                ?>
                         &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp;  &nbsp; <input style="color: #000000; background-color: #F1948A" class="letrap" type="submit" name="Boton" value="Validar"></input> &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp;  &nbsp; 
                        <a href=javascript:winmed('pdfradiologia.php?busca=<?= $busca ?>&Estudio=<?= $estudio ?>')><i class='fa fa-file-pdf-o fa-2x' aria-hidden='true' style='color:#FF0000'></i></a></td></tr>
                <?php
                
                    }else{
                ?>

                         &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp;  &nbsp; <input style='color: #000000; background-color: #F1948A' class='letrap' type='submit' name='Validar' value='Validar'></input> &nbsp; &nbsp;  &nbsp; &nbsp;
                        <font color='red'><b> <--- Validar para imprimir --- </b></font>
                <?php
                    }
        ...
        <table align="center" width="98%" border="0">
            <tr>
                ...
                <td align="center" width="80%" valign="top">
                    ...
                    <?php
                    $cc2 = "SELECT * FROM estudiospdf WHERE id='$busca' and usrelim='' order by idnvo";
                    ...
                    while ($row2 = mysql_fetch_array($ImgA2)) {
                        ...
                        if ($cExt == 'JPG' or $cExt == 'BMP' or $cExt == 'PNG' or $cExt == 'JPEG') {
                    ?>
                    ...
                    <div class="w3-center">
                        <?php
                        $cc3 = "SELECT * FROM estudiospdf WHERE id='$busca' and usrelim='' order by idnvo";
                        ...
                        while ($row3 = mysql_fetch_array($ImgA3)) {
                            ...
                            if ($cExt2 == 'JPG' or $cExt2 == 'BMP' or $cExt2 == 'PNG' or $cExt2 == 'JPEG') {
                        ?>
                        ...
                        <tr>
                            <td colspan="2" align="center">
                                <table width="98%" style="margin-top: 10px;border:#000 1px solid;border-color: #999; border-radius: .5em;" border="0">
                                    ...
                                    $sql = "SELECT * FROM log 
                                                WHERE accion like ('/Interpretacion/%') 
