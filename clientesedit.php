...
if ($_REQUEST[bt] == "Actualizar") {
    ...
    $sql = "UPDATE cli SET nombrec='$Nombrec',apellidop='$_REQUEST[Apellidop]',apellidom='$_REQUEST[Apellidom]',nombre='$_REQUEST[Nombre]',sexo='$_REQUEST[Sexo]', fechan='$_REQUEST[Fechan]', estado='$_REQUEST[Estado]', municipio = '$_REQUEST[Municipio]', localidad = '$_REQUEST[Localidad]', direccion = '$_REQUEST[Direccion]',codigo='$_REQUEST[Codigo]', telefono = '$_REQUEST[Telefono]', celular = '$_REQUEST[Celular]', mail = '$_REQUEST[Mail]', refubicacion='$_REQUEST[Refubicacion]'  WHERE cliente = $busca;";
                    ...
                    <td valign='top' align='center' height='440' width='45%'>
                        <table width='98%' align='center' border='0' cellpadding='1' cellspacing='2' bgcolor='#f1f1f1' style='border-collapse: collapse; border: 1px solid #999;'>  
                            ...
                            <tr style="height: 30px">
                                ...
                                <td class="Inpt">
                                    <input type='date' class='cinput'  name='Fechan' value='<?= $Fechan ?>' required> </input>
                                    Edad : <?= $Edad ?>
                                </td>
                            </tr>
                        </table>  
