...
$Team='LCD - Matriz';
$pdf->SetHeaderData('DuranNvoBk.png', '45', '    Laboratorio Clinico Duran S.A. de C.V.','                                                                                                                                                 Movimiento al almacen                                                           Concepto: Transferencia');//define ("PDF_HEADER_LOGO", "logo_example.png");
...
$html='<br></br><br></br><br></br><table align="center" width="100%" border="0"><tr><td align="left"><b> No.Transferencia: </b>'.$He[id].'</td><td align="left"><b>Fecha: </b>'.$He[fecha].' - '.$He[hora].'</td><td align="left"><b>Almacen De/Para: </b>'.$De.' / '.$Para.'</td></tr></table>';
