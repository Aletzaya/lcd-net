...
if($numreg>0){
    ...
    while ($Elex = mysql_fetch_array($ElX)) {
        ...
        $tipos = mysql_query("SELECT tipo FROM $tabla WHERE estudio='$estudio' and id='$Ressulele' ");
...
//******** Captura nueva ****************//
    ...
    }elseif($_REQUEST[Liberar] == "Liberar"){

        $Msj = "Liberación con exito!";
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <table border='0' width='99%' align='center' cellpadding='1' cellspacing='4'>    
        ...
        <table border='0' width='99%' align='center' cellpadding='1' cellspacing='4'>    
            <?php
            $Validaciocero=0;
            echo "<form name='form1' method='post' action='estdeptovalida.php?busca=$busca&estudio=$estudio&alterno=$alterno'>";
                    ...
                    if ($Ele[tipo] == 'n') {
                        ...
                        if($Vlr[n] < $Ele[min]  OR $Vlr[n] > $Ele[max]){
                            ...
                            if($Tcap=='Validada'){
                                ...
                                $Confirma = "<a href='estdeptovalida.php?busca=$busca&estudio=$estudio&alterno=$alterno&validacampo=Si&campoval=$Campo'><b><i class='fa fa-ban fa-lg' style='color:black;' aria-hidden='true'></i><b></a>";
                                $Validaciocero++;
                            }
            ...
            if ($Otd[capturo] <> '') {
                ...
                if ($Otd[status] == 'TERMINADA') {
                        ...
                        echo "<td align='center' colspan='3'><br><input style='color: #000000; background-color: #F1948A' class='letrap' type='submit' name='Liberar' value='Liberar'></input> &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <a href=javascript:wingral2('resultapdf.php?clnk=$clnk&Orden=$busca&Estudio=$estudio&Depto=TERMINADA&op=im&alterno=$alterno')><i class='fa fa-print fa-lg' aria-hidden='true' style='color:#FF0000'></i></a></td></tr>";
            
                }else{

                    if($Validaciocero==0){
                        echo "<td align='center' colspan='3'><br><input style='color: #000000; background-color: #F1948A' class='letrap' type='submit' name='Liberar' value='Liberar'></input> &nbsp &nbsp &nbsp <font color='red'><b> <--- Liberar --- </b></font></td></tr>";
                     }
                }
