...
if ($_REQUEST["Cliente"] <> '') {
    ...
    header("Location: facturas40e.php?busca=$busca");
}
    ...
    <body topmargin="1">
        ...
        <form name='form0' method='get' action="<?= $_SERVER['PHP_SELF'] ?>" onSubmit='return ValidaCampos();'>
            <table width="100%" class="letrap">
                <tr>
                    <td width="40%">
                        <a href="clientesf40.php?busca=ini" class="NvaFact"> Nueva Factura <i style="color:#0071c5" class="fa fa-plus-square" aria-hidden="true"></i></a>
                    </td>
