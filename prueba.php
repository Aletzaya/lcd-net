...
echo '<table width="100%" border="0" cellpadding="0" cellspacing="0">';
echo '<tr>';
echo '<td height="95" valign="bottom">';
    ...
    echo '<td width="40%" valign="bottom" style="background-image:url(images/BarraVdeGrad.jpg)">';
        ...
        echo '<tr>';
        echo '<td width="80" id="recepcion" height="86"><a href="recepcion.html"  class="recepcion" ></a></td>';
...
echo '<td width="0" height="34"></td>';
echo    '<td height="0" valign="top" bgcolor="#FFFFFF">';
echo        '<div id="two-level-recepcion">';
echo            '<ul id="horizontal-main-menu">';
echo                    '<li><a href="#" title="">Captura OTs</a>';
echo                            '<ul class="dropdown-second-menu">';
echo                            '<li ><a class="dropdown-menu-a" href="" title="">Cotización</a></li>'; 
echo                            '</ul></li>';
echo                    '<li><a href="#" title="">Consulta OTs</a></li>';
    ...
    jQuery(function($) {
        ...
        $('#reportes').mouseover(function () {
            ...
            if($('#two-level-reportes').css('display') == 'none') {
                ...
                ocultar('#two-level-recepcion', '#two-level-catalogos', '#two-level-ingresos', '#two-level-procesos', '#two-level-facturacion', '#two-level-moviles');
            }
        });
        // Close menu when mouse leaves Hidden Content
