...
$EstA      = mysql_query("SELECT cliente,nombrec,direccion,localidad,municipio,numveces,programa,observaciones FROM cli WHERE cliente='$busca'");
...
//Tabla Principal    
  ...
  echo "<table border='1' width='100%' align='center' cellpadding='1' cellspacing='4'>";    
    ...
    echo "</table>";
        ...
        echo "<tr class='letrap' align='left'><td><b>Direccion: </b></td></tr>";
        ...
        echo "<tr class='letrap' align='justify'><td>$Est[direccion], $Est[localidad], $Est[municipio]</td></tr>";
        //       cInput("Condiciones: ", "Text", "3", "condiciones", "left", , "3", 1, 1, '');                
        echo "</table>";
        ...
        echo "<table width='100%' align='center' border='0' cellpadding='1' cellspacing='2' bgcolor='#EBF5FB' style='border-collapse: collapse; border: 1px solid #999;'>";
        echo "<tr class='letrap' align='left'><td><b>Numero de Visitas: </b></td></tr>";
        //       cInput("Condiciones: ", "Text", "3", "condiciones", "left", , "3", 1, 1, '');                
        echo "</table>";

        echo "<table width='100%' align='center' border='0' cellpadding='1' cellspacing='2' bgcolor='#f1f1f1' style='border-collapse: collapse; border: 1px solid #999;'>";
        echo "<tr class='letrap' align='justify'><td>$Est[numveces]</td></tr>";
        //       cInput("Condiciones: ", "Text", "3", "condiciones", "left", , "3", 1, 1, '');                
        echo "</table>";
        ...
        echo "<table width='100%' align='center' border='0' cellpadding='1' cellspacing='2' bgcolor='#EBF5FB' style='border-collapse: collapse; border: 1px solid #999;'>";
        echo "<tr class='letrap' align='left'><td><b>Programa al que pertenece: </b></td></tr>";
        //       cInput("Condiciones: ", "Text", "3", "condiciones", "left", , "3", 1, 1, '');                
        echo "</table>";

        echo "<table width='100%' align='center' border='0' cellpadding='1' cellspacing='2' bgcolor='#f1f1f1' style='border-collapse: collapse; border: 1px solid #999;'>";
        echo "<tr class='letrap' align='justify'><td>$aPrg[$nPrg]</td></tr>";
        //       cInput("Condiciones: ", "Text", "3", "condiciones", "left", , "3", 1, 1, '');                
        echo "</table>";
