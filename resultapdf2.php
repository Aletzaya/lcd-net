...
$OtA=mysql_query("select ot.suc, ot.medico,cli.nombrec as nomcli,cli.sexo,cli.fechan,med.nombrec,ot.medicon,ot.institucion,ot.diagmedico,cli.afiliacion,ot.fecha,ot.observaciones,ot.servicio from ot,cli,med where ot.orden='$Orden' and ot.cliente=cli.cliente and ot.medico=med.medico",$link);
...
class MYPDF extends TCPDF {
    ...
    function Footer() {
        ...
        <tr>
        <td width="800" align="left" ><FONT COLOR="gray">Capturo &nbsp;/&nbsp; '.$Cap1[recepcionista] .' &nbsp;/&nbsp;
        Toma &nbsp;/&nbsp; '.$Cap[usrest] .' &nbsp;/&nbsp; Proceso &nbsp;/&nbsp; '.$Cap[proceso] .' &nbsp;/&nbsp; 
        Captura &nbsp;/&nbsp; '.$Cap[capturo] .' &nbsp;/&nbsp; Valida &nbsp;/&nbsp; '.$Cap[usrvalida] .'</FONT></td></tr>
        </table>', false, 0);
...
//	$descripcion= utf8_encode(ucwords(strtolower($Ele[descripcion])));
	...
	$Perlab=mysql_query("select * from perlab where alias='$Cap[usrvalida]'",$link);
