<?php
  ...
  <head>
  <meta charset="UTF-8">
  <title>Imprimir Reporte de Gastos </title>
  ...
  $doc_title    = "Imprimir Reporte de Gastos ";
...
class MYPDF extends TCPDF {
    ...
    <td align="center" bgcolor="#808B96" width="80">Tipo P.</td>
    <td align="center" bgcolor="#808B96" width="130">Recibe</td>
    <td align="center" bgcolor="#808B96" width="130">Autoriza</td>
    <td align="center" bgcolor="#808B96" width="70">Usr</td>
...
while($rg=mysql_fetch_array($sql)){          
    ...
    if( ($nRng % 2) > 0 ){
        $Fdo='CDCDFA';
            ...
            <td width="80"> '.$rg[concepto].' </td>
            <td width="130"> '.ucwords($rg[recibe]).'</td>
            <td width="130"> '.$rg[autoriza].'</td>
            <td width="70">'.$rg[usr].' </td>
            <td width="50"> '.$rg[hospi].'</td>
