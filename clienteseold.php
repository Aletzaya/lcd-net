...
$Retornar  = "clientes.php?buscar=ini";
...
if($_REQUEST[Boton] == Cancelar){
    ...
    if($busca == 'NUEVO'){
        ...
        $cSql  = "INSERT INTO cli (apellidop,apellidom,nombre,nombrec,fecha,fechan,localidad,municipio,
                  codigo,estado,institucion,fechan_real)
                 VALUES
                 ('$Apellidop','$Apellidom','$Nombre',
                 '$Nombrec','$Fecha','$Fechan','$Cpo[colonia]','$Cpo[municipio]','$Cpo[codigo]',
                 '$Cpo[estado]','$_REQUEST[Institucion]','$Fechan_real')";
                      
    }else{            
    
        //$NombreFind = $busca . ' ' . $_REQUEST[Clave] . ' ' . $Nombrec;
        ...
        $cSql =  "UPDATE cli SET apellidop = '$Apellidop', apellidom='$Apellidom',
              ...
              fecha='$_REQUEST[Fecha]',usr='$_REQUEST[Usr]',usrmod='$_REQUEST[Usrmod]',numveces='$_REQUEST[Numveces]',suc='$_REQUEST[Suc]',
              codigo='$_REQUEST[Codigo]',observaciones='$_REQUEST[Observaciones]',clave='$_REQUEST[Clave]',
              fuente='$_REQUEST[Fuente]',historial='$_REQUEST[Historial]',celular='$_REQUEST[Celular]',mailalt='$_REQUEST[Mailalt]'
              ,redsoc='$_REQUEST[Redsoc]',centrotr='$_REQUEST[Centrotr]',departamento='$_REQUEST[Departamento]'
              ,organismo='$_REQUEST[Organismo]',nota='$_REQUEST[Nota]',descuentos='$_REQUEST[Descuentos]',restricciones='$_REQUEST[Restricciones]',
              facturar='$_REQUEST[Facturar]',alias='$_REQUEST[Alias]',otrodato='$_REQUEST[Otrodato]',
              adhesion='$_REQUEST[Adhesion]',inai='$_REQUEST[Inai]',arco='$_REQUEST[Arco]',numero='$_REQUEST[Numero]',
              interior='$_REQUEST[Interior]',sistemacp='$_REQUEST[Sistemacp]'
              WHERE cliente='$busca'";
    ...
    if($busca == 'NUEVO'){
       $cId = mysql_insert_id();    
       header("Location: clientese.php?busca=$cId");
    }else{
       header("Location: clientes.php");
...
echo "<tr><td valign='top' align='center' height='440'>";
    ...
    if($busca =='NUEVO'){
        ...
        //cTable('90%', '0',$Titulo);
            ...
            echo "Ap.materno: ";
            echo "<input class='cinput' type='text' name='Apellidom' size='15' value='$Cpo[apellidop]'> &nbsp; ";
            ...
            echo "<input type='text'class='letrap' name='Fechan' value='0000-00-00' size='12'> &nbsp; ";
            echo "Edad:&nbsp;";
	    ...
	    echo "<input type='text' class='letrap' name='Anos' value='$Anos' size='2'> &nbsp;";
            ...
            cInput("Colonia : ", "Text", "30", "Colonia", "right", $Cpo[localidad], "50", 1, 0, '');
...
echo "</td><td valign='top'>";
    ...
    if($busca <> 'NUEVO'){
        ...
        //cTable('90%', '0',$Titulo);
            ...
            if($Cpo[expira] == S){$SiExp = checked;}else{$NoExp=checked;}
