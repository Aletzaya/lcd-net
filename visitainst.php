...
if (isset($_REQUEST["busca"])) {
    ...
    if ($_REQUEST["busca"] == "ini") {
        ...
        $_SESSION["OnToy"] = array('', '', 'vinst.id', 'Asc', $Retornar);   //Inicio arreglo(0=busca,1=pagina,2=orden,3=Asc,4=a donde regresa)
...
$cSql = "SELECT $Qry[campos] FROM $Qry[froms] LEFT JOIN inst ON vinst.inst=inst.institucion WHERE $BusInt";
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta charset="UTF-8">
            ...
            <title>Registro Visitas Institucion</title>
