...
require_once ("com/softcoatl/cfdi/complemento/pagos/Pagos10.php");
require_once ("PagosFactoryIface.php");

use com\softcoatl\cfdi\complemento\pagos\Pagos;
use com\softcoatl\cfdi\complemento\pagos\Pagos10;

class Pagos10Factory implements PagosFactoryIface {
    ...
    public function createPagosPago(array $rs): Pagos\Pago {
        ...
        if ($pago->getMonedaP()!=="MXN") {
            $pago->setTipoCambioP($rs["TipoCambioP"]);
        }
