...
if(isset($_REQUEST[busca])){
    ...
    if($_REQUEST[busca] == ini ){           
      ...
      $_SESSION["OnToy"] = array('','','est.estudio','Asc',$Retornar);   //Inicio arreglo(0=busca,1=pagina,2=orden,3=Asc,4=a donde regresa)
...
$op        = $_REQUEST[op];
$Msj       = $_REQUEST[Msj];
$Id        = 34;             //Numero de query dentro de la base de datos
//
...
if(strlen($Qry[filtro])>34){$Dsp='Filtro activo';}
...
#Armo el query segun los campos tomados de qrys;
$cSql   = "SELECT $Qry[campos] FROM est WHERE $BusInt $Qry[filtro]";
...
echo '<td height="380" valign="top">';
    ...
    while($rg=mysql_fetch_array($res)){
        ...
        if($RetSelec <>''){
            echo "<td class='Seleccionar' align='center'><a class='edit' href='$RetSelec?Paciente=$rg[estudio]'>Seleccionar</a></td>";
        }else{
            echo "<td class='Seleccionar' align='center'><a class='edit' href='$cLink?busca=$rg[estudio]'>Editar</a></td>";
        }
