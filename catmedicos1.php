...
if (isset($_REQUEST["busca"])) {
    ...
    if ($_REQUEST["busca"] == "ini") {
        ...
        $_SESSION["OnToy"] = array('', '', 'med.nombrec', 'Asc', 'ordenesnvas.php');   //Inicio arreglo(0=busca,1=pagina,2=orden,3=Asc,4=a donde regresa)
...
//Tabla contenedor de brighs
    ...
    while ($rg = mysql_fetch_array($res)) {
        ...
        echo "<td class='Seleccionar' align='center'><a class='edit' href='ordenesnvas.php?Medico=$rg[id]'>Seleccionar</a></td>";
