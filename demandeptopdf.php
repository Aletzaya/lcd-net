...
// ********************  E N C A B E Z A D O  ****************
	...
	class MYPDF extends TCPDF {
		...
		$this->writeHTML('<br><br><table align="center" width="1150" border="0" cellspacing="1" cellpadding="0"><tr><td align="center" bgcolor="#808B96" width="70">Depto</td><td align="center" bgcolor="#808B96" width="150">Subdepto</td><td align="center" bgcolor="#808B96" width="150">Estudio</td><td align="center" bgcolor="#808B96" width="320">Descripcion</td><td align="center" bgcolor="#808B96" width="100">Precio</td><td align="center" bgcolor="#808B96" width="70">#Est</td><td align="center" bgcolor="#808B96" width="100">Sub-total</td><td align="center" bgcolor="#808B96" width="100">Desctos</td><td align="center" bgcolor="#808B96" width="100">Importe</td></tr></table>', false, 0);
...
//$FechaAnt=date("Y-m-d",$nDias);
        ...
        while($registro=mysql_fetch_array($UpA)) {
    		if($subdep==$registro[8]){
		       ...
		       // $pdf->writeHTML($html,true,false,true,false,'C');
	    		...
	    		if($Noveces<>0){
			        $html='<table align="center" width="1150" border="0" cellspacing="1" cellpadding="0"><tr><td align="center" width="70"></td><td align="center" width="150"></td><td align="center" width="150"></td><td align="center" width="320" bgcolor="#808B96"><strong>T o t a l</strong></td><td align="center" width="100" bgcolor="#808B96"><strong> - </strong></td><td align="center" width="70" bgcolor="#808B96"><strong>'.number_format($Noveces2).'</strong></td><td align="right" width="100" bgcolor="#808B96"><strong>'.number_format($Subtotal2,"2").'</strong></td><td align="right" width="100" bgcolor="#808B96"><strong>'.number_format($Descuentos2,"2").'</strong></td><td align="right" width="100" bgcolor="#808B96"><strong>'.number_format($Total2,"2").'</strong></td></tr></table>';
		...
		$html='<table align="center" width="1150" border="0" cellspacing="1" cellpadding="0"><tr>
		  ...
		  <td width="150"><strong>'.$subdepartamento.'</strong></td>
		  <td width="150">'.$registro[0].'</td>
		  <td align="left" width="320">'.$registro[1].'</td>
		  <td align="right" width="100">'.number_format($registro[2],"2").'</td>
		  <td align="center" width="70">'. number_format($registro[3]).'</td>
		  <td align="right" width="100">'. number_format($registro[4],"2").'</td>
		  <td align="right" width="100">'. number_format($registro[5],"2").'</td>
		  <td align="right" width="100">'. number_format($registro[4]-$registro[5],"2").'</td>
		</tr></table>';
        ...
        <td align="center" width="150"></td>
        <td align="center" bgcolor="#808B96" width="320"><strong>T o t a l</strong></td>
        <td align="center" bgcolor="#808B96" width="100"><strong> - </strong></td>
		<td align="center" bgcolor="#808B96" width="70"><strong>'.number_format($Noveces2).'</strong></td>
        <td align="right" bgcolor="#808B96" width="100"><strong>'.number_format($Subtotal2,"2").'</strong></td>
        <td align="right" bgcolor="#808B96" width="100"><strong>'.number_format($Descuentos2,"2").'</strong></td>
        <td align="right" bgcolor="#808B96" width="100"><strong>'.number_format($Total2,"2").'</strong></td>
        </tr>
        <tr><td></td></tr>
        <tr><td></td></tr>
        <tr>
        <td align="center" width="70"></td>
        <td align="center" width="150"></td>
        <td align="CENTER" bgcolor="#808B96" width="150"><strong> No. Ordenes : '.number_format($registro2[0]).'</strong></td>
        <td align="CENTER" bgcolor="#808B96" width="320"><strong>Total Gral.</strong></td>
        <td align="CENTER" bgcolor="#808B96" width="100"><strong> - </strong></td>
        <td align="center" bgcolor="#808B96" width="70"><strong>'.number_format($Noveces3).'</strong></td>
        <td align="right" bgcolor="#808B96" width="100"><strong>'.number_format($Subtotal3,"2").'</strong></td>
        <td align="right" bgcolor="#808B96" width="100"><strong>'.number_format($Descuentos3,"2").'</strong></td>
        <td align="right" bgcolor="#808B96" width="100"><strong>'.number_format($Total3,"2").'</strong></td>
        </tr>
        </table><br><br><br>';
        ...
        $html='<table align="center" width="1150" border="0" cellspacing="1" cellpadding="0">
       	...
       	<td align="center" bgcolor="#808B96" width="100"><strong> - </strong></td>
       	<td align="center" bgcolor="#808B96" width="100"><strong>Sub-total</strong></td>
       	<td align="center" bgcolor="#808B96" width="100"><strong> Desctos </strong></td>
       	<td align="center" bgcolor="#808B96" width="100"><strong>I m p o r t e</strong></td>
       	<td align="center" bgcolor="#808B96" width="100"><strong> - </strong></td>
       	</tr>
        </table>';
        ...
        while($dm=mysql_fetch_array($UpB)) {
				...
				if (($nRng % 2) > 0) {
  	      		...
  	      		$html.='<tr bgcolor='.$Fdo.'>
        		<td align="left" width="70" bgcolor="#FFF"> </td>
        		...
        		<td align="right" width="100">'.number_format($dm[precio],"2").' &nbsp; </td>
        		<td align="right" width="100">'.number_format($dm[importe],"2").' &nbsp; </td>
        		<td align="right" width="100">'.number_format($dm[precio]-$dm[importe],"2").' &nbsp; </td>
        		<td align="center" width="100">'.number_format((($dm[precio]-$dm[importe])/$Total3)*100,"0").' % </td>
        		</tr>';
        		$nRng++;
        }
