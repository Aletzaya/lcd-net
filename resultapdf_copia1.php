...
class MYPDF extends TCPDF {
    ...
    function Footer() {
       ...
       // Set font
        ...
        <tr>
        <td width="100" align="left" ><FONT COLOR="gray">Capturo &nbsp;/&nbsp;'.$Cap1[recepcionista] .'</FONT></td>
        <td width="100" align="left"><FONT COLOR="gray">Toma &nbsp;/&nbsp;'.$Cap[usrest] .'</FONT></td>
        <td width="100" align="left"><FONT COLOR="gray">Proceso &nbsp;/&nbsp;'.$Cap[proceso] .'</FONT></td>
        <td width="100" align="left"><FONT COLOR="gray">Captura &nbsp;/&nbsp;'.$Cap[capturo] .'</FONT></td>
        <td width="100" align="left"><FONT COLOR="gray">Valida &nbsp;/&nbsp;'.$Cap[ usrvalida] .'</FONT></td></tr>
        </table>', false, 0);
