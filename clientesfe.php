...
if ($_REQUEST[bt] == "NUEVO") {
    ...
    $sql = "INSERT INTO clif (nombre,direccion,colonia,municipio,telefono,alias,contacto,
               codigo,rfc,correo,numeroint,numeroext,enviarcorreo,cuentaban,estado,correoadm)
               VALUES
               ('$_REQUEST[Nombre]','$_REQUEST[Direccion]','$_REQUEST[Colonia]','$_REQUEST[Municipio]',
               '$_REQUEST[Telefono]','$_REQUEST[Alias]','$_REQUEST[Contacto]','$_REQUEST[Codigo]','$_REQUEST[Rfc]','$_REQUEST[Correo]','$_REQUEST[Numeroint]','$_REQUEST[Numeroext]','$REQUEST[Enviarcorreo]','$_REQUEST[Cuentaban]','$_REQUEST[Estado]','$_REQUEST[Correoadm]');";
