        ...
        if ($Orden <> $rg[orden]) { 
            if ($Orden <> 0) { 
               ...
               $pdf->SetFont('Helvetica', '', 7, '', 'false');
                ...
                <td align="left" width="300">'.$rg[2].'&nbsp; '.$rg[numveces].' vecs</td>
                <td  width="330">Fecha Cap.: '.$rg[fecha].'&nbsp;&nbsp;&nbsp;Fec.ent: '.$rg[fechae].''.substr($rg[horae],0,5).'</td>
            ...
            if (!$regenvio = mysql_fetch_array($reg)) {
               ...
               <td align="left" width="350">'.$rg[descripcion].'&nbsp;&nbsp;'.$rg[estpropio]/$rg[muestras]/$rg[entord].'</td>
               <td align="center"><img src="images/'.$entregrecep1.'"></a>&nbsp;&nbsp;/<img src="images/'.$entregvirtual.'"></a></td>
