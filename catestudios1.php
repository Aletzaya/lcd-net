...
if (isset($_REQUEST["busca"])) {
    ...
    if ($_REQUEST["busca"] == "ini") {
        ...
        $_SESSION["OnToy"] = array('', '', 'est.descripcion', 'Asc', 'ordenesnvas.php');   //Inicio arreglo(0=busca,1=pagina,2=orden,3=Asc,4=a donde regresa)
...
#Armo el query segun los campos tomados de qrys;
$cSql = "SELECT $Qry[campos],est.id FROM est WHERE $BusInt $Qry[filtro]";
...
//Tabla contenedor de brighs
    ...
    while ($rg = mysql_fetch_array($res)) {
        ...
        echo "<td align='center'><a class='edit' href='ordenesnvas.php?IdEstudio=$rg[id]'>Seleccionar</a></td>";
