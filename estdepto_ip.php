...
$aIzq = array("Cap", "-", "-", "Etiq", "-", "-", "Imp", "-", "-", "Img", "-", "-", "Proc", "-", "-", "Suc", "-", "-");    //Arreglo donde se meten los encabezados; Izquierdos
$aDat = SPLIT(",", $Qry[edi]);     //Arreglo donde llena el grid de datos
//$aDer = array("Msj", "-", "-", "Tom/Real", "-", "-", "Proc", "-", "-");    //Arreglo donde se meten los encabezados; Derechos;
$aDer = array("ObsG", "-", "-","Correo", "-", "-", "Tom/Real", "-", "-", "Ent.Recep", "-", "-");    //Arreglo donde se meten los encabezados; Derechos;
$tamPag = $Qry[tampag];
                    ...
                    while ($rg = mysql_fetch_array($res)) {
                        ...
                        if ($rg[depto] <> 2) {
                            ...
                            if($rg[subdepto] == 'RX_DENTAL'){
                                ...
                                echo "<td class='Seleccionar' align='center'><a class='edit' href=javascript:winuni('estdeptodental.php?busca=$rg[orden]&estudio=$rg[estudio]&alterno=$rg[alterno]')><i class='fa fa-pencil-square-o fa-lg' aria-hidden='true' style='color:#E74C3C'></i></a></td>";
                        ...
                        if ($rg[capturo] <> '') {
                            ...
                            if ($rg[depto] <> 2) {
                                ...
                                if ($rg[status] == 'TERMINADA' and $rg[usrvalida] <> '') {
                                    ...
                                    echo "<td class='Seleccionar' align='right'><a class='edit' href=javascript:wingral('resultapdf_ip.php?cInk=$clnk&Orden=$rg[orden]&Estudio=$rg[estudio]&Depto=TERMINADA&op=im&alterno=$rg[alterno]')><i class='fa fa-file-pdf-o fa-lg' aria-hidden='true' style='color:#FF0000'></i></a></td>";
                                ...
                                if($rg[subdepto] == 'RX_DENTAL'){
                                    ...
                                    echo "<td align='right'><a href=javascript:wingral('pdfradiologiadental.php?busca=$rg[orden]&Estudio=$rg[estudio]')><i class='fa fa-file-pdf-o' aria-hidden='true' style='color:#0000FF' title='Vista preliminar'></i></a></td> ";
