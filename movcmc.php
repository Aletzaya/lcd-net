...
if (isset($_REQUEST["busca"])) {
    ...
    if ($_REQUEST["busca"] == "ini") {
        ...
        $_SESSION["OnToy"] = array('', '', 'cmc.id', 'Asc', $Retornar);   //Inicio arreglo(0=busca,1=pagina,2=orden,3=Asc,4=a donde regresa)
...
if($Palabras > 1){
 ...
 for ($i = 0; $i < $Palabras; $i++) {
        if(!isset($BusInt)){$BusInt=" cmc.concepto like '%$P[$i]%' ";}else{$BusInt=$BusInt." and cmc.concepto like '%$P[$i]%' ";}
 }
 //$Suc='*';

}else{
        $BusInt=" cmc.concepto like '%$busca%' or cmc.medico like '%$busca%'"; 
// $Suc='*';
}
