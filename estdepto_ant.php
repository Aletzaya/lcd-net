                        ...
                        if ($rg[capturo] <> '') {
                            ...
                            if ($rg[depto] <> 2) {
                                ...
                                if ($rg[status] == 'TERMINADA' and $rg[usrvalida] <> '') {
                                    ...
                                    echo "<td class='Seleccionar' align='right'><a class='edit' href=javascript:winuni('resultapdf.php?cInk=$clnk&Orden=$rg[orden]&Estudio=$rg[estudio]&Depto=TERMINADA&op=im&alterno=$rg[alterno]')><i class='fa fa-file-pdf-o fa-lg' aria-hidden='true' style='color:#FF0000'></i></a></td>";
                                ...
                                if($rg[subdepto] == 'RX_DENTAL'){
                                    ...
                                    echo "<td align='right'><a href=javascript:wingral('pdfdental.php?busca=$rg[orden]&Estudio=$rg[estudio]')><i class='fa fa-file-pdf-o' aria-hidden='true' style='color:#0000FF' title='Vista preliminar'></i></a></td> ";
