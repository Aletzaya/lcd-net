    ...
    <body topmargin="1">
        ...
        <form name='frmfiltro' method='get' action="<?= $_SERVER['PHP_SELF'] ?>">
            ...
            <select class='letrap' name='Correo' onChange='frmfiltro.submit();'>
                <?php
                    echo "<option value='No Enviados'> No Enviados </option>";
                    echo "<option value='Parcial'> Parcial </option>";
                    echo "<option value='Enviados'> Enviados </option>";
                    echo "<option value='* Correos'> * Correos </option>";
                    echo "<option value='Sin filtro'> Sin filtro </option>";
                    echo "<option selected value=$GCorreo> $GCorreo </select>";
                ?>
