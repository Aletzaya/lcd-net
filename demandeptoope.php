...
<?php
        ...
        while($registro=mysql_fetch_array($UpA)) {
    		if($subdep==$registro[8]){
		        ...
		        echo "<tr><td></td><td></td><td></td><td></td><td colspan='1'><hr></td></tr>";
	    		if($Noveces<>0){
			        echo "<tr>";
...
echo "<div align='center'>";        
echo "<form name='form1' method='post' action='pidedatos.php?Menu=3&fechas=1&FechaI=$FechaI&FechaF=$FechaF'><a class='edit' href=javascript:wingral('demandeptoopepdf.php?FechaI=$FecI&FechaF=$FecF&Institucion=$Institucion3&Departamento=$Departamento1&sucursalt=$sucursalt&sucursal0=$sucursal0&sucursal1=$sucursal1&sucursal2=$sucursal2&sucursal3=$sucursal3&sucursal4=$sucursal4&sucursal5=$sucursal5&sucursal6=$sucursal6&Servicio=$Servicio1')><i class='fa fa-print fa-3x' aria-hidden='true'></i></a></i>";
