...
if (isset($_REQUEST["busca"])) {
    ...
    if ($_REQUEST["busca"] == "ini") {
        ...
        $_SESSION["OnToy"] = array('', '', 'invl.id', 'Asc', 'ordenesnvas.php', $_REQUEST["miBusca"]);   //Inicio arreglo(0=busca,1=pagina,2=orden,3=Asc,4=a donde regresa)
...
$op = $_REQUEST["op"];
$Msj = $_REQUEST["Msj"];
$Id = 14;             //Numero de query dentro de la base de datos
...
//Tabla contenedor de brighs
    ...
    while ($rg = mysql_fetch_array($res)) {
        ...
        echo "<td height='20px' align='center'><a class='edit' href='pedidod.php?ralId=$rg[id]&nvoId=$rg[clave]&busca=" . $_SESSION['OnToy'][5] . "'>Seleccionar</a></td>";
