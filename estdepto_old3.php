                            ...
                            if ($rg[depto] <> 2) {
                                ...
                                if ($rg[status] == 'TERMINADA' and $rg[usrvalida] <> '') {
                                    ...
                                    if($sipdf==1){
                                        ...
                                        echo "<td align='center'><font size='1'><b><a class='edit' href=javascript:wingral('estdeptovalida.php?busca=$rg[orden]&estudio=$rg[estudio]&alterno=$rg[alterno]')>S/Valid</a></b></font></td>";
