...
$gsql = "SELECT sum(cja.importe) ImporteCaja, fecha FROM cja WHERE cja.fecha AND cja.fecha >= '$FechaI' AND cja.fecha <= '$FechaF' GROUP BY cja.fecha;";
//echo $gsql;
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body topmargin="1">
        ...
        menu($Gmenu, $Gusr);
        ?> 
        <h2 style="color: #5c6773"> <i style="color:#58D68D" class="fa fa-bar-chart fa-1x" aria-hidden="true"></i> Grafica de ingresos del dia <?= $FechaI ?> al dia <?= $FechaF ?></h2>
