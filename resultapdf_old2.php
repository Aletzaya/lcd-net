...
if($Team=='2'){
    ...
    $domicilio3="Col. Revolucion, Chicoloapan, Edo. de Mex. C.P 56390 ";
...
class MYPDF extends TCPDF {
    ...
    function Header() {
       ...
       // $link="<input type=button value=Imprimir onclick='print()'>";
        ...
        $this->writeHTML('<table width="100"><tr><td width="500">&nbsp;</td><td width="700">'.$institucion.' - '.$Orden.' &nbsp;&nbsp; '.$nombrecli.' &nbsp;&nbsp; '.$edad.'</td></tr></table>', false, 0);
