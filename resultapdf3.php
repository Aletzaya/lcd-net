...
class MYPDF extends TCPDF {
    ...
    function Header() {
        ...
        $this->writeHTML('<table width="100"><tr><td width="25">&nbsp;</td><td width="700">Sexo: '.$sexo.' &nbsp;&nbsp;&nbsp; Fech Ord: '.$FechaLet.' &nbsp;&nbsp;&nbsp; Fech Realiz: '.$fechavalida.' - '.$Horaval.' hrs.</td></tr></table>', false, 0);
    ...
    if ($Ele[tipo] == 'n') {
        ...
        if ($Res[$Ele[tipo]] > $Ele[max] or $Res[$Ele[tipo]] < $Ele[min]) {
            ...
            if ($Res[$Ele[tipo]] == 0) {
                ...
                $html = '<table width="800" border="0" cellspacing="0" cellpadding="5"><tr style="background-color: ' . $Fdo . ';color: #000;"><td width="20" align="rigth">' . $imagen . '</td><td width="400" align="center">' . $descripcion . '</td><td width="180" align="center" height="30" border="1"><b>' . number_format($Res[$Ele[tipo]], $Decimal) . '   ' . $Ele[unidad] . '</b></td>' . $valref . '<td width="410" height="30" style="text-align:justify;"><font size="8">' . $nota . '</font></td></tr></table>';
            }
        } else {

            $html = '<table width="800" border="0" cellspacing="0" cellpadding="5"><tr style="background-color: ' . $Fdo . ';color: #000;"><td width="20" align="rigth"></td><td width="400" align="center">' . $descripcion . '</td><td width="180" align="center" height="30">' . number_format($Res[$Ele[tipo]], $Decimal) . '   ' . $Ele[unidad] . '</td>' . $valref . '<td width="410" height="30" style="text-align:justify;"><font size="8">' . $nota . '</font></td></tr></table>';
        }
    } elseif ($Ele[tipo] == 't') {
