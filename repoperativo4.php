...
if($filtro3=='*'){
  ...
  <html xmlns="http://www.w3.org/1999/xhtml">
      ...
      <?php
        ...
        <h2 style="color: #5c6773">Reporte de Productividad Operativa - Proceso del <?= $FechaI ?> al <?= $FechaF ?></h2>
...
//                    $cTit = $cTit . "<td align='center'>$Gfon ".number_format($aCnt[$x],'0')."</font></td>";
              ...
              <td align='center'><a href=javascript:winuni('repoperativod4.php?FecI=$FechaI&FecF=$FechaF&usuario=$capt&Sucursal=$filtro3&Institucion=$filtro5&Depto=$filtro7')>$Gfont <b>$capt</b></a>
              </td></td>";
  ...
  <td align='right'>$Gfon2 <b>$ ".number_format($PromedioGimp,'2')."</b></td></tr>";
    ...
    echo "</div>";
        ...
        echo "<div align='center'>";
    echo "<td class='Seleccionar' align='center'><a class='edit' href=javascript:wingral('repoperativo4pdf.php?pagina=$pagina&Sort=Asc&busca=$busca&filtro=$filtro&filtro3=$filtro3&filtro5=$filtro5&filtro7=$filtro7&filtro9=$filtro9&FechaI=$FechaI&FechaF=$FechaF')><i class='fa fa-print fa-3x' aria-hidden='true'></i></a></td>";
