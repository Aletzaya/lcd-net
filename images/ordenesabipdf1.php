        ...
        if ($Orden <> $rg[orden]) { 
            if ($Orden <> 0) { 
               ...
               $pdf->SetFont('Helvetica', '', 7, '', 'false');
                ...
                <td  width="340">Fecha Cap.: '.$rg[fecha].'&nbsp;&nbsp;&nbsp;Fec.ent: '.$rg[fechae].''.substr($rg[horae],0,5).'</td>
                <td align="center" width="50">T.Entr.<img src="images/'.$entregrecepc.'"></a>&nbsp;&nbsp;/<img src="images/'.$entregcorreo.'"></a></td>
