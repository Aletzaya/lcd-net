...
$link=conectarse();
 ...
 if($filtro3=='*'){
  ...
  $output = '<table align="center" width="100%" border="1">
<tr bgcolor="#a2b2de">
<td align="center" WIDTH="280" colspan="4"></td>
<td align="center" colspan="2"> <b>De '.$FechaI.' al '.$FechaF.'</b></td>
<td align="center" colspan="2"> <b>De '.$FechaI2.' al '.$FechaF2.'</b></td>
<td align="center" colspan="2"> <b>Diferencia</b></td></tr>

<tr bgcolor="#a2b2de">
<td align="center" WIDTH="60" colspan="2"> <b>Estudio</b></td>
<td align="center"  WIDTH="220" colspan="2"> <b>Descripcion</b></td>
    ...
    //echo "<table width='100%' align='center' border='0'>";
  	...
  	while ($reg1 = mysql_fetch_array($est3)) {
  		...
  		if($canti1<>0 or $canti2<>0){
              ...
              <td align="center" WIDTH="60" colspan="2">'.$reg1[estudio].'</td>
              <td align="left"  WIDTH="220" colspan="2">'.$reg1[descripcion].'</td>
          ...
          <td align="right"  WIDTH="220"colspan="2"><b>Totales --------> </b></td>
...
class MYPDF extends TCPDF {
  ...
  function Header() {
    ...
    // Logo
      ...
      <th width="610"><font size="10"><b>Laboratorio Clinico Duran S.A. de C.V.</b></font></th></tr><tr>
      <th width="78" height="15"></th><th width="610">Fray Pedro de Gante Norte No 108 Texcoco de Mora Cp.56100</th></tr><tr>
      <th width="78" height="18">&nbsp;</th><th width="610"><b>Demanda Comparativa por Estudio &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Fecha/Hora:  &nbsp; &nbsp; '.$Fecha.'</b></th>
      </tr></table>', false, 0);
