...
$html='<table align="center" width="1150" border="1">
<tr>
<td align="center" bgcolor="#808B96" width="150">Depto</td>
<td align="center" bgcolor="#808B96" width="550">Subdepto</td>
<td align="center" bgcolor="#808B96" width="450">#Estudios</td>
</tr></table>';
...
$pdf->writeHTML($html,true,false,true,false,'');
        ...
        while ($registro = mysql_fetch_array($UpA)) {
            ...
            if ($subdep == $registro[8]) {
                ...
                if ($Noveces <> 0) {
                    ...
                    $html='<table align="center" width="1150" border="0" >
                    <tr bgcolor='.$Fdo.'>
                    <td align="center" width="150">'.$departamento1.'</td>
                    <td align="center" width="550" >'.$subdepartamento1.'</td>
                    <td align="center" width="450"> '. number_format($Noveces2) . '</td>
                    </tr>
                    </table>';
                    $pdf->writeHTML($html,true,false,true,false,'');
        ...
        $html='<table align="center" width="1150" border="0" >
        <tr>
        <td align="center"  width="150" bgcolor="#D5D8DC">'.$departamento1.'</td>
        <td align="center"  width="550" bgcolor="#D5D8DC">'.$subdepartamento1.'</td>
        <td align="center"  width="450" bgcolor="#D5D8DC"> '. number_format($Noveces2) . '</td>
        </tr>
        </table>';
        $pdf->writeHTML($html,true,false,true,false,'');
        ...
        <td align="CENTER" width="550" bgcolor="#808B96">No. Ordenes:'. number_format($registro2[0]).'</td>
        <td align="center" width="450" bgcolor="#808B96">'.number_format($Noveces3) .'</td>
        </tr>
        </table>';
        $pdf->writeHTML($html,true,false,true,false,'');
        ...
        while($dm=mysql_fetch_array($UpB)) {
				...
				if (($nRng % 2) > 0) {
  	      		...
  	      		$html.='<tr bgcolor='.$Fdo.'>
        		<td align="left" width="300" bgcolor="#FFF"> </td>
