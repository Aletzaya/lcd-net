...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <table border='0' width='99%' align='center' cellpadding='1' cellspacing='4'>    
        ...
        <table border='0' width='99%' align='center' cellpadding='1' cellspacing='4'>    
            <?php
            $Validaciocero=0;
            echo "<form name='form1' method='post' action='estdeptocvalcppdf3.php?busca=$busca&estudio=$estudio&alterno=$alterno'>";
                    ...
                    if ($Ele[tipo] == 'n') {
                        ...
                        if($Vlr[n] < $Ele[min]  OR $Vlr[n] > $Ele[max]){
                            ...
                            if($Tcap=='Validada'){
                                ...
                                $Confirma = "<a href='estdeptocvalcppdf3.php?busca=$busca&estudio=$estudio&alterno=$alterno&validacampo=Si&campoval=$Campo'><b><i class='fa fa-ban fa-lg' style='color:black;' aria-hidden='true'></i><b></a>";
                                $Validaciocero++;
                            }
           ...
           // echo "<td align='center' colspan='3'><br><input style='color: #000000; background-color: #F1948A' class='letrap' type='submit' name='Validar' value='Validar'></input> &nbsp &nbsp &nbsp <font color='red'><b> <--- Validar para imprimir --- </b></font></td></tr>";
            ...
            if ($Otd[capturo] <> '') {
                ...
                if ($Otd[status] == 'TERMINADA') {
                        ...
                        echo "<td align='center' colspan='3'><br><input style='color: #000000; background-color: #F1948A' class='letrap' type='submit' name='Validar' value='Validar'></input> &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <a href=javascript:wingral('resultapdf.php?clnk=$clnk&Orden=$busca&Estudio=$estudio&Depto=TERMINADA&op=im&alterno=$alterno')><i class='fa fa-print fa-lg' aria-hidden='true' style='color:#FF0000'></i></a></td></tr>";
