...
if ($_REQUEST["Boton"] === "Actualiza") {
    $existencia = $_REQUEST[Invgral] + $_REQUEST[Invmatriz] + $_REQUEST[Invtepex] + $_REQUEST[Invhf] + $_REQUEST[Invreyes] + $_REQUEST[Invgralreyes] + $_REQUEST[Invcam] + $_REQUEST[Invsnv];

    $DepSql2 = mysql_query("SELECT dep.departamento FROM dep,depd WHERE depd.subdepto='$_REQUEST[Subdepto]' and depd.departamento=dep.departamento and '$_REQUEST[Subdepto]'<>'' ");
    $ResDep2 = mysql_fetch_array($DepSql2);
    ...
    $Update = "UPDATE $Tabla SET clave='$_REQUEST[Clave]',descripcion='$_REQUEST[Descripcion]',"
            ...
            . "depto='$ResDep2[departamento]',subdepto='$_REQUEST[Subdepto]',uso='$_REQUEST[Uso]',min='$_REQUEST[Min]',max='$_REQUEST[Max]',"
            ...
            . "invhf='$_REQUEST[Invhf]',invreyes='$_REQUEST[Invreyes]',invgralreyes='$_REQUEST[Invgralreyes]',invcam='$_REQUEST[Invcam]',invsnv='$_REQUEST[Invsnv]',"
            . "existencia='$existencia',pertenece='$_REQUEST[Pertenece]',ctrl='$_REQUEST[ctrl]',costo = '$_REQUEST[Costo]' WHERE id='$busca' limit 1";
    echo $Update;
    if (mysql_query($Update)) {
        $Msj = "Registro actualizado con Exito!";
        header("Location: repinve.php?busca=$busca&Msj=$Msj");
    }
    ...
    $Insert = "INSERT INTO invl (clave,descripcion,presentacion,pzasmedida,marca,iva,depto,subdepto,uso,min,max,status,presentacionp,"
            . "npruebas,suc1,suc2,suc3,suc4,suc5,suc6,metodo,proveedor1,proveedor2,proveedor3,referencia,invgral,invmatriz,invtepex,"
            . "invhf,invreyes,invgralreyes,existencia,pertenece,ctrl,costo,invcam,invsnv ) "
            . "VALUES ('$_REQUEST[Clave]','$_REQUEST[Descripcion]','$_REQUEST[Presentacion]','$_REQUEST[Pzasmedida]','$_REQUEST[Marca]',"
            . "'$_REQUEST[Iva]','$ResDep2[departamento]','$_REQUEST[Subdepto]','$_REQUEST[Uso]','$_REQUEST[Min]','$_REQUEST[Max]','$_REQUEST[Status]',"
            . "'$_REQUEST[Presentacionp]','$_REQUEST[Npruebas]','$_REQUEST[Suc1]','$_REQUEST[Suc2]','$_REQUEST[Suc3]','$_REQUEST[Suc4]',"
            . "'$_REQUEST[Suc5]','$_REQUEST[Suc6]','$_REQUEST[Metodo]','$_REQUEST[Proveedor1]','$_REQUEST[Proveedor2]','$_REQUEST[Proveedor3]',"
            . "'$_REQUEST[Referencia]','$_REQUEST[Invgral]','$_REQUEST[Invmatriz]','$_REQUEST[Invtepex]','$_REQUEST[Invhf]','$_REQUEST[Invreyes]',"
            . "'$_REQUEST[Invgralreyes]','$existencia','$_REQUEST[Pertenece]','$_REQUEST[ctrl]','$_REQUEST[Costo]','$_REQUEST[Invcam]','$_REQUEST[Invsnv]);";
    if (mysql_query($Insert)) {
        $Id = mysql_insert_id();
        $Msj = "Registro agregado con Exito! Id no . $Id";
        header("Location: repinve.php?busca=$Id&Msj=$Msj");
    }
}
                ...
                <tr>
                    <td width='50%' valign="top">
                        <table width='98%' bgcolor="#F2F2F2" align='center' cellpadding='0' class='letrap' cellspacing='0' style='border:#CCC 1px solid;border-color: #999; border-radius: .5em;'>
                            ...
                            ?>
                            <tr height='25px'><td align='right'>Departamento: </td><td><input type="text" name="Depto" value="<?= $ResDep[nombre] ?>" class="letrap" disabled></td></tr>
                    ...
                    <td align='center' valign="top">
                        <table width='98%' bgcolor="#F2F2F2" align='center' cellpadding='0' class='letrap' cellspacing='0' style='border:#CCC 1px solid;border-color: #999; border-radius: .5em;'>
                            <tr height='25px' bgcolor='#2c8e3c'><td colspan="2" align='center' class='letratitulo'>Informacion Principal</td></tr>
                            <tr height='25px'><td align='right'>Almacen General : </td><td><input type="text" name="Invgral" value="<?= $Cpo[invgral] ?>" class="letrap"></td></tr>
                            <tr height='25px'><td align='right'>Almacen Matriz: </td><td><input type="text" name="Invmatriz" value="<?= $Cpo[invmatriz] ?>" class="letrap"></td></tr>
                            <tr height='25px'><td align='right'>Almacen Tepexpan: </td><td><input type="text" name="Invtepex" value="<?= $Cpo[invtepex] ?>" class="letrap"></td></tr>
                            <tr height='25px'><td align='right'>Almacen Futura </td><td><input type="text" name="Invhf" value="<?= $Cpo[invhf] ?>" class="letrap"></td></tr>
                            <tr height='25px'><td align='right'>Almacen Gral. Reyes: </td><td><input type="text" name="Invgralreyes" value="<?= $Cpo[invgralreyes] ?>" class="letrap"></td></tr>
                            <tr height='25px'><td align='right'>Almacen Reyes: </td><td><input type="text" name="Invreyes" value="<?= $Cpo[invreyes] ?>" class="letrap"></td></tr>
                            <tr height='25px'><td align='right'>Almacen Camarones: </td><td><input type="text" name="Invcam" value="<?= $Cpo[invcam] ?>" class="letrap"></td></tr>
                            <tr height='25px'><td align='right'>Almacen San Vicente: </td><td><input type="text" name="Invsnv" value="<?= $Cpo[invsnv] ?>" class="letrap"></td></tr>
                            <tr height='25px'><td align='right'>Exist. General: </td><td><input type="text" name="Existencia" value="<?= $Cpo[existencia] ?>" class="letrap" disabled></td></tr>
