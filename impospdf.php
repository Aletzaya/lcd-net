...
$OtA=mysql_query("SELECT * from ct where busca='$busca'",$link);
...
$html='<br><table border="0" cellspacing="0" cellpadding="0"><tr><td width="250" style="text-align:justify;"><font size="11" color="red">Cotización: '.$busca.'</font></td><td width="200" style="text-align:justify;"><font size="9">Fecha: '.$Fecha.'</font></td><td width="150" style="text-align:justify;"><font size="9">Hora: '.$hora.'</font></td><td width="250" style="text-align:justify;"><font size="9">Atendio: '.$Usr.'</font></td><td width="300" style="text-align:justify;"><font size="9">Sucursal: '.$Team.'</font></td></tr></table><br><br>';
