...
$Titulo="Relacion de Ordenes de trabajo";
...
if ($DesctoS == "S") {
    ...
    if ($Sucursal <> '*') {
        $cSql   = "SELECT ot.orden, ot.fecha, cli.nombrec, cli.afiliacion, otd.estudio, est.descripcion, otd.precio, 
                   ...
                   ot.horae,est.clavealt,ot.suc,otd.recibepac,ot.entemailpac,ot.entemailmed,ot.entemailinst,ot.entmosf,ot.entmost,ot.entmoslr,ot.entmoscms,ot.entmosch,ot.tentregamost
...
class MYPDF extends TCPDF {
    ...
    $this->writeHTML('<br><br><table align="center" width="1150" border="0" cellspacing="1" cellpadding="0"><tr><td align="center" bgcolor="#808B96" width="110">Suc-Inst-Ord</td><td align="center" bgcolor="#808B96" width="300">Paciente</td><td align="center" bgcolor="#808B96" width="150">Estudios</td><td align="center" bgcolor="#808B96" width="280"></td><td align="center" bgcolor="#808B96" width="110">Precio</td><td align="center" bgcolor="#808B96" width="110">Desc. %</td><td align="center" bgcolor="#808B96" width="110">Importe</td></tr></table><br>', false, 0);
        ...
        if ($Orden <> $rg[orden]) { 
            if ($Orden <> 0) { 
               ...
               $pdf->SetFont('Helvetica', '', 7, '', 'false');
                ...
                <td align="left" width="330">'.$rg[2].'&nbsp; '.$rg[numveces].' vecs</td>
                <td  width="350">Fecha Cap.: '.$rg[fecha].'&nbsp;&nbsp;&nbsp;Fec.ent: '.$rg[fechae].''.substr($rg[horae],0,5).'</td>
			...
			if($Institucion==94){
               ...
               <td align="left" width="420">'.$rg[descripcion].'&nbsp;&nbsp;'.$rg[estpropio]/$rg[muestras]/$rg[entord].'</td>
