...
if ($_REQUEST["bt"] === "Actualizar") {
    ...
    $Sql = "UPDATE perlab SET nombre='$_REQUEST[Nombre]',profesion='$_REQUEST[Profesion]',cedula='$_REQUEST[Cedula]',"
    ...
    if (mysql_query($Sql)) {
        $Sql = "INSERT INTO log (usr,accion,tabla,fecha,cliente) VALUES "
                . "('$Gusr','/Admin/Personal Lab./Datos Principales','perlab',now(),$busca);";
        if (mysql_query($Sql)) {
            header("Location: perlab.php?busca=ini");
        }
    }
    ...
    if (mysql_query($Sql)) {
        header("Location: perlab.php?busca=$Id&Msj=Registro actualizado con exito!");
    }
}
        ...
        <table border='0' width='99%' align='center' cellpadding='1' cellspacing='4'>    
            <tr>
                <td colspan="3" style="background-color: #2c8e3c" width='80%' class='Subt' align='center'>
                    ..:: Detalle del personal de laboratorio no. <?= $busca ?> ::..
                </td>
            </tr>
            <tr>
                        ...
                        <tr>
                            <td colspan="2">
                                <table align="center" width="95%" style="border:#000 1px solid;border-color: #999; border-radius: .5em;" border="0">
                                    ...
                                    <?php
                                    $sql = "SELECT * FROM log 
                                                WHERE accion like ('/Admin/Personal Lab./Datos%') 
                ...
                <td valign='top' width="22%">
                    <a href="perlab.php" class="content5" ><i class="fa fa-reply fa-2x" aria-hidden="true"></i> Regresar </a>
                    <a class="cMsj">
                        <?= $msj ?>
                    </a>
                </td>
