        ...
        <table width='100%' border='0' cellpadding='2' cellspacing='1' bgcolor='#f1f1f1' style='border-collapse: collapse; border: 1px solid #999;'>
            ...
            while ($row = mysql_fetch_array($ImgA)) {
                ...
                if ($cExt == 'PDF') {
                    ...
                    echo "<tr><td align='center'><embed src='https://lcd-system.com/lcd/estudios/$foto' type='application/pdf' width='100%' height='1300px' /></td></tr>";

                        //    echo "<tr><td align='center'><embed src='estudios/$foto' type='application/pdf' width='100%' height='1300px' /></td></tr>";   

                } elseif ($cExt == 'DOCX') {

                    echo "<tr><td align='center'><iframe src='//view.officeapps.live.com/op/embed.aspx?src=https://lcd-system.com/lcd/estudios/$foto' style='width:100%; height:50%; border: none;min-height:500px;'></iframe></td></tr>";
                } elseif ($cExt == 'XLSX') {

                    echo "<tr><td align='center'><iframe src='//view.officeapps.live.com/op/embed.aspx?src=https://lcd-system.com/lcd/estudios/$foto' style='width:100%; height:50%; border: none;min-height:500px;'></iframe></td></tr>";
                } elseif ($cExt == 'DCM') {

                    echo "<a href='https://lcd-system.com/lcd/estudios/$foto' style='width:100%; height:50%; border: none;min-height:500px;')><img src='lib/Pdf.gif' title=$Pdf border='0'></a> &nbsp; &nbsp; ";
                    ...
                    echo "<tr><td align='center'><IMG SRC='../lcd/estudios/$foto' border='0' width='1200'></td></tr>";
                }

                echo "<tr class='content_txt'><td bgcolor='#2980b9' align='left' colspan='2'><font color='#FFFFCC'>" . ucfirst(strtolower($row[archivo])) . "  &nbsp; &nbsp; Usuario:  ".ucfirst(strtolower($row[usr]))." &nbsp; &nbsp; Fecha/Hora: ".$row[fechasub]."</font></td></tr>";
