        ...
        <table border='0' width='99%' align='center' cellpadding='1' cellspacing='4'>    
            ...
            <tr>
                <td valign='top' align='center' height='440' width='45%'>
                    ...
                    <table width='98%' align='center' border='0' cellpadding='1' cellspacing='2' bgcolor='#f1f1f1' style='border-collapse: collapse; border: 1px solid #999;'>  
                        <tr style="background-color: #2c8e3c">
                            <td class='letratitulo'align="center" colspan="7">
                                ..:: Facturado ::..
                            </td>
                        </tr>
                        <tr class="letrap" style="height: 30px">
                        ...
                        while ($cc = mysql_fetch_array($cSql)) {
                          ...
                          $He = mysql_fetch_array($HeA);
                            ...
                            <tr class="letrap" bgcolor="<?= $Fdo ?>">
                                    ...
                                    <td><?= $nvo ?></td>
                                    <td><?= $He[nombre]?></td>
                                    <td><a class='content1' href=javascript:winuni('facturase.php?busca=<?= $cc[id] ?>')><b>ENVIAR CORREO</a></td>
                                    <td><a class='content1' href=javascript:winuni('facturase1.php?busca=<?= $cc[id] ?>')><b>ENVIAR CORREO ANTERIOR</a></td>
                            </tr>
                            <?php
                                }
                            }
