...
if (isset($_REQUEST["busca"])) {
    ...
    if ($_REQUEST["busca"] == "ini") {
        ...
        $_SESSION["OnToy"] = array('', '', 'inst.institucion', 'Asc', 'pedidod.php',$_REQUEST["miBusca"]);   //Inicio arreglo(0=busca,1=pagina,2=orden,3=Asc,4=a donde regresa)
...
//Tabla contenedor de brighs
    ...
    while ($rg = mysql_fetch_array($res)) {
        ...
        echo "<td height='20px' align='center'><a class='edit' href='visitainste.php?nvoId=$rg[institucion]&busca=" . $_SESSION['OnToy'][5] . "'>Seleccionar</a></td>";
