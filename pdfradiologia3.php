<?php
  ...
  $OtA	   = mysql_query("SELECT ot.fecha,ot.hora,ot.fechae,ot.servicio,ot.cliente,ot.medico,ot.diagmedico,
  			 ...
  			 medi.cedula,medi.profesion,medi.sexo, otd.letra,ot.suc,otd.fechaest
...
if ($Ot[institucion]<>'125'){
  ...
  if($Ot[suc]=='0'){
    ...
    $cFecha = "Chicoloapan, Edo. de Mexico a: ". substr($Fecha,8,2)." de ".$aMes[$nMes]." del ".substr($Fecha,0,4);
  }
...
$pdf->writeHTML('<table border="0">
		         <tr><th align="left"><b>'.ucwords(strtoupper($Ot[nombrec])).'</b></th></tr>
