...
class MYPDF extends TCPDF {
    ...
    <td align="center" bgcolor="#808B96" width="140">Suc-Inst-Ord</td>
    <td align="center" bgcolor="#808B96" width="300">Paciente</td>
    <td align="center" bgcolor="#808B96" width="180">Estudios</td>
    <td align="center" bgcolor="#808B96" width="358">Ent. Recep / Ent. Correo</td>
    <td align="center" bgcolor="#808B96" width="110">Capturo</td>
    <td align="center" bgcolor="#808B96" width="100">Servicio</td>
    </tr></table><br>', false, 0);
   ...
   while ($rg = mysql_fetch_array($UpA)) {
        if ($Orden <> $rg[orden]) { 
            if ($Orden <> 0) { 
                ...
                <tr>
                <td  width="140" >'.$Med1.'-&nbsp;</td>
                <td align="left" width="300">'.$Med2.'</td>
                <td width="180" color="red">'.$Urgencia.'</td>
                <td align="center"  width="358" ></td>
            ...
            if (!$regenvio = mysql_fetch_array($reg)) {
               ...
               <td align="left" width="510">'.$rg[descripcion].'&nbsp;&nbsp;'.$rg[estpropio]/$rg[muestras]/$rg[entord].'</td>
               <td align="right" width="70"><img src="images/'.$entregrecep1.'" /></td><td align="left" width="60">&nbsp;/&nbsp;<img src="images/'.$entregvirtual.'" /></td>
