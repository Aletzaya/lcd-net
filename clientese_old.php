...
if ($_REQUEST[bt] == "NUEVO") {
    ...
    $sql = "INSERT INTO cli (nombrec,apellidop,apellidom,nombre,sexo,fechan) VALUES "
            . "('$Nombrec','$_REQUEST[Apellidop]','$_REQUEST[Apellidom]','$_REQUEST[Nombre]','$_REQUEST[Sexo]','$_REQUEST[Fechan]');";
    if (!mysql_query($sql)) {
