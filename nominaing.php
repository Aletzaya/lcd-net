...
if ($_REQUEST["Op"] === "Delete") {
    ...
    if (mysql_query($SqlD)) {
        ...
        $Return = "nominaing.php";
        AgregaBitacoraEventos($Gusr, "/R.Humanos/Nomina/Ingresos/Borra registro de nomina id " . $_REQUEST["Elimina"], "nomf", $Fecha, $_SESSION["OnToy1"][5], $Msj, $Return);
    }
}
            ...
            <tr>
                <td height="380" valign="top">
                    ...
                    while ($rg = mysql_fetch_array($res)) {
                        ...
                        echo "<td class='Seleccionar' align='center'><a class='edit' href='nominaing.php?Elimina=$rg[id]&Op=Delete'><i class='fa fa-trash fa-2x' aria-hidden='true'></i></a></td>";
                        echo "</tr>";
