...
if ($_REQUEST["bt"] === "Actualizar") {
    ...
    $Sql = "UPDATE sl SET concepto='$_REQUEST[Concepto]',recibio='$_REQUEST[Recibio]',status='$_REQUEST[Status]',"
            . "fecha='$Fecha',hora='$_REQUEST[Hora]',depto='$_REQUEST[Depto]',unidad='$_REQUEST[Unidad]',almacen='$_REQUEST[Almacen]' "
            . "WHERE id='$busca' limit 1";
    echo $Sql;

    if (mysql_query($Sql)) {
        $Sql = "INSERT INTO log (usr,accion,tabla,fecha,cliente) VALUES "
                . "('$Gusr','/Admin/Salidas/Datos Principales','sl',now(),$busca);";
        if (mysql_query($Sql)) {
            header("Location: sallabe.php?busca=$busca&Msj=Registro actualizado con exito!");
        }
    }
    ...
    $Fecha = date("Y-m-d");
    $Hora = date("H:i");
    $Sql = "INSERT INTO sl (fecha,hora,concepto,recibio,status,depto,unidad,almacen)"
            . " VALUES ('$Fecha','$Hora','$_REQUEST[Concepto]','$_REQUEST[Recibio]','ABIERTA',"
            . "'$_REQUEST[Depto]','$_REQUEST[Unidad]','$_REQUEST[Almacen]')";
    if (mysql_query($Sql)) {
        $Id = mysql_insert_id();
        $Sql = "INSERT INTO log (usr,accion,tabla,fecha,cliente) VALUES "
                . "('$Gusr','/Admin/Salidas/Datos Principales Creacion','sl',now(),$Id);";
        if (mysql_query($Sql)) {
            header("Location: sallabe.php?busca=$Id&Msj=Registro actualizado con exito!");
        }
    }
}
                    ...
                    <table width='98%' align='center' border='0' cellpadding='1' cellspacing='2' bgcolor='#f1f1f1' style='border-collapse: collapse; border: 1px solid #999;'>  
                        <form name='form1' method='get' action="<?= $_SERVER['PHP_SELF'] ?>" onSubmit='return ValidaCampos();'>
                            ...
                            <tr style="height: 30px">
                                <td width='45%' align="right" class="Inpt">No. de salida : </td>
                                <td class="Inpt">
                                    <?= $busca ?>
                                </td>
                            </tr>
                            <tr style="height: 30px">
                                ...
                                <td class="Inpt">
                                    <?php $_REQUEST["busca"] === "NUEVO" ? $date = date("Y-m-d") : $date = $Cpo["fecha"]; ?>
                            ...
                            <tr style="height: 30px">
                                ...
                                <td class="Inpt">
                                    <?php $_REQUEST["busca"] === "NUEVO" ? $date = date("H:i") : $date = $Cpo["hora"]; ?>
                            ...
                            <tr style="height: 30px">
                                ...
                                <td class="Inpt">
                                    <select name='Concepto' class="letrap">
                            ...
                            <tr style="height: 30px">
                                <td align="right" class="Inpt">Recibio : </td>
                            ...
                            <tr style="height: 30px">
                                <td align="right" class="Inpt">Almacen : </td>
                                <td>
                                    <select name='Almacen' class="letrap">
                                        ...
                                        <option selected value='<?= $Cpo[almacen] ?>'><?= $Cpo[almacen] ?></option>
                                    </select>
                                </td>
                            </tr>
                            <tr style="height: 30px">
                                <td align="right" class="Inpt">Departamentos : </td>
                                <td>
                                    <select name='Depto' class="letrap">";
                            ...
                            <tr style="height: 30px">
                                ...
                                <td>
                                    <select name='Unidad' class="letrap">";
                        ...
                        <tr>
                            <td colspan="2">
                                <table align="center" width="95%" style="border:#000 1px solid;border-color: #999; border-radius: .5em;" border="0">
                                    ...
                                    <?php
                                    $sql = "SELECT * FROM log 
                                                WHERE accion like ('/Admin/Salidas/Datos%') 
