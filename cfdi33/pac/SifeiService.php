...
abstract class SifeiCaller {
    ...
    protected function invoke($operation) {
        ...
        error_log("SIFEI response " . print_r($this->response, true));
        error_log("SOAP exception " . print_r($this->soapException, true));
        error_log("SIFEI exception " . print_r($this->sifeException, true));
        return $this;
    }
    ...
    public function getHTMLError() {
        $error = explode("<br>", $this->soapException);
        return $this->sifeiError() ? 
