        ...
        <fo:root 
            ...
            <fo:layout-master-set>
                <fo:simple-page-master master-name="simpleA4" page-height="29.7cm" page-width="21cm" margin-top="1.5cm" margin-bottom="3cm" margin-left="1cm" margin-right="1cm">
                    <fo:region-body region-name="xsl-region-body" margin-bottom="5.5cm" margin-top="3.5cm"/>
                    <fo:region-before region-name="xsl-region-before" extent="3cm"/>
                    <fo:region-after region-name="xsl-region-after" extent="5.5cm"/>
                ...
                <fo:static-content flow-name="xsl-region-before">
                    <fo:block padding-bottom="15pt">
                        <fo:table table-layout="fixed" width="100%" border-collapse="separate">
                            ...
                            <fo:table-body>
                                <fo:table-cell>
                                    <fo:block padding="1pt 1pt 1pt 1pt">
                                        <fo:external-graphic 
                                            width="3.5cm"
            ...
            <xsl:when test="$observaciones">
                <xsl:for-each select="$observaciones/Observacion">
                    <fo:table-row>
                        <fo:table-cell>
                            <fo:block padding-top="10px">
                                <fo:inline font-size="6pt" font-style="italic" font-weight="bold" color="gray">
                                    <xsl:value-of select="@Descripcion"/>
                                </fo:inline>
                            </fo:block>
                        </fo:table-cell>
