...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" exclude-result-prefixes="fo">
    ...
    <xsl:template match="Comprobante">
        <fo:root 
            ...
            <fo:layout-master-set>
                <fo:simple-page-master master-name="general" page-height="29.7cm" page-width="21cm" margin-top="1cm" margin-bottom="3cm" margin-left="1cm" margin-right="1cm">
                    <fo:region-body region-name="xsl-region-body" margin-bottom="4.5cm" margin-top="5.3cm"/>
                    <fo:region-before region-name="xsl-region-before" extent="3cm"/>
                    <fo:region-after region-name="xsl-region-after-g" extent="4.5cm"/>
                </fo:simple-page-master>
                <fo:simple-page-master master-name="last" page-height="29.7cm" page-width="21cm" margin-top="1cm" margin-bottom="3cm" margin-left="1cm" margin-right="1cm">
                    <fo:region-body region-name="xsl-region-body" margin-bottom="8cm" margin-top="5.3cm"/>
                    <fo:region-before region-name="xsl-region-before" extent="3cm"/>
                    <fo:region-after region-name="xsl-region-after-l" extent="8cm"/>
                </fo:simple-page-master>
                <fo:page-sequence-master master-name="all">
                    <fo:repeatable-page-master-alternatives>
                        <fo:conditional-page-master-reference page-position="last" master-reference="last"/>
                        <fo:conditional-page-master-reference page-position="other-page" master-reference="general"/>
                    </fo:repeatable-page-master-alternatives>
            ...
            <fo:page-sequence master-reference="all" initial-page-number="1">
                                                                ...
                                                                <fo:table>
                                                                    ...
                                                                    <fo:table-body>
                                                                        ...
                                                                        <fo:table-row>
                                                                            ...
                                                                            <fo:table-cell>
                                                                                <fo:block font-weight="bold">Tipo de Cambio</fo:block>
                                                                            </fo:table-cell>
                                                                            <fo:table-cell>
                                                                                <fo:block>
                                                                        ...
                                                                        <fo:table-row>
                                                                            <fo:table-cell>
                                                                                <fo:block font-weight="bold">Forma de Pago</fo:block>
                                                                            </fo:table-cell>
                                                                            <fo:table-cell number-columns-spanned="3">
                                                                                <xsl:call-template name="formaPago">
                                                                                    <xsl:with-param name="fp" select="@FormaPago"/>
                                                                                </xsl:call-template>
                                                                            </fo:table-cell>
                                                                        </fo:table-row>
                                                                        <fo:table-row>
                                                                            <fo:table-cell>
                                                                                <fo:block font-weight="bold">Método de Pago</fo:block>
                                                                            </fo:table-cell>
                                                                            <fo:table-cell number-columns-spanned="3">
                                                                                <xsl:call-template name="metodoPago">
                                                                                    <xsl:with-param name="mp" select="@MetodoPago"/>
                                                                                </xsl:call-template>
                                                                            </fo:table-cell>
                                                                        </fo:table-row>
                                                                        <fo:table-row>
                ...
                <fo:static-content flow-name="xsl-region-after-l">
                    <fo:block font-size="8pt" font-weight="bold" >
                        <fo:table>
                            ...
                            <fo:table-body>
                                ...
                                <fo:table-row>
                                    <fo:table-cell number-columns-spanned="4" height="3.5cm">
                                        <fo:block>
                                            <fo:table padding-top="10px">
                                                <fo:table-column column-width="12cm"/>
                                                <fo:table-column column-width="7cm"/>
                                                <fo:table-body>
                                                    <fo:table-row>
                                                        <fo:table-cell border-width="3px 0px 0px 0px"  border-style="solid" border-color="#6BA5D9">
                                                            <fo:block>
                                                                <fo:table>
                                                                    <fo:table-body>
                                                                        <fo:table-row>
                                                                            <fo:table-cell>
                                                                                <fo:block>Importe con Letra: <xsl:value-of select="$importe_letra"/></fo:block>
                                                                            </fo:table-cell>
                                                                        </fo:table-row>
                                                                    </fo:table-body>
                                                                </fo:table>
                                                            ...
                                                            <fo:block>
                                                                <fo:table>
                                                                    ...
                                                                    <fo:table-body>
                                                                        ...
                                                                        <xsl:call-template name="formatDiscount">
                                                                            <xsl:with-param name="discount" select="@Descuento"/>
                                                                        </xsl:call-template>
                                                                        <xsl:for-each select="/Comprobante/Impuestos/Traslados/Traslado">
                                                                            <fo:table-row>
                                                                                <fo:table-cell>
                                                                                    <fo:block>
                                                                                        <xsl:call-template name="formatTax">
                                                                                            <xsl:with-param name="tax" select="@Impuesto"/>
                                                                                            <xsl:with-param name="rate" select="@TasaOCuota"/>
                                                                                            <xsl:with-param name="type" select="@TipoFactor"/>
                                                                        ...
                                                                        <xsl:for-each select="/Comprobante/Impuestos/Retenciones/Retencion">
                                                                            <fo:table-row>
                                                                                <fo:table-cell>
                                                                                    <fo:block>
                                                                                        <xsl:call-template name="formatTax">
                                ...
                                <xsl:call-template name="formatRelatedCFDI">
                                    <xsl:with-param name="relaciones" select="CfdiRelacionados"/>
                                </xsl:call-template>
                                <fo:table-row>
                                    <fo:table-cell>
                                                                ...
                                                                <fo:table font-size="9pt">
                                                                    <fo:table-body>
                                                                        ...
                                                                        <fo:table-row>
                                                                            <fo:table-cell>
                                                                                <fo:block font-size="6pt" line-height="8pt" font-family="Courier">
                                                                                    <xsl:value-of select="replace(replace($cadena_original, '(\P{Zs}{128})', '$1&#x200B;'),'&#x200B;(\p{Zs})','$1')"/>
                                                                                </fo:block>
                                                                            </fo:table-cell>
                                                                        </fo:table-row>
                                                                        <fo:table-row>
                                                                        ...
                                                                        <fo:table-row>
                                                                            <fo:table-cell>
                                                                                <fo:block font-size="6pt" line-height="8pt" font-family="Courier">
                                                                                    <xsl:value-of select="replace(replace(Complemento/TimbreFiscalDigital/@SelloCFD, '(\P{Zs}{128})', '$1&#x200B;'),'&#x200B;(\p{Zs})','$1')"/>
                                                                                </fo:block>
                                                                            </fo:table-cell>
                                                                        </fo:table-row>
                                                                        <fo:table-row>
                                                                        ...
                                                                        <fo:table-row>
                                                                            <fo:table-cell>
                                                                                <fo:block font-size="6pt" line-height="8pt" font-family="Courier">
                                                                                    <xsl:value-of select="replace(replace(Complemento/TimbreFiscalDigital/@SelloSAT, '(\P{Zs}{128})', '$1&#x200B;'),'&#x200B;(\p{Zs})','$1')"/>
                                                                                </fo:block>
                                                                            </fo:table-cell>
                                                                        </fo:table-row>
                                                                    </fo:table-body>
                ...
                <fo:static-content flow-name="xsl-region-after-g">
                    <fo:block font-size="8pt" font-weight="bold" >
                        <fo:table>
                            <fo:table-column column-width="3.3cm"/>
                            <fo:table-column column-width="6.2cm"/>
                            ...
                            <fo:table-body>
                                ...
                                <fo:table-row border-width="3px 0px 0px 0px"  border-style="solid" border-color="#6BA5D9">
                                    <fo:table-cell border-color="#D2D1D2" border-width="0.5px" border-style="solid">
                                        <fo:block background-color="#D2D1D2">No. Certificado Digital</fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell border-color="#D2D1D2" border-width="0.5px" border-style="solid">
    ...
    <xsl:template name="formatRelatedCFDI">
        <xsl:param name="relaciones"/>
        <xsl:choose>
            <xsl:when test="$relaciones">
                <xsl:variable name="tipo" select="$relaciones/@TipoRelacion" />
                <xsl:for-each select="$relaciones/CfdiRelacionado">
                    <fo:table-row>
                        <fo:table-cell border-color="#D2D1D2" border-width="0.5px" border-style="solid">
                            <fo:block background-color="#D2D1D2">CFDI Relacionado</fo:block>
                        </fo:table-cell>
                        <fo:table-cell border-color="#D2D1D2" border-width="0.5px" border-style="solid">
                            <fo:block text-align="center">
                        ...
                        <fo:table-cell border-color="#D2D1D2" border-width="0.5px" border-style="solid">
                            <fo:block background-color="#D2D1D2">Tipo de Relacion</fo:block>
                        </fo:table-cell>
                        <fo:table-cell border-color="#D2D1D2" border-width="0.5px" border-style="solid">
                            <fo:block text-align="center">
                                <xsl:call-template name="formatRelationship">
