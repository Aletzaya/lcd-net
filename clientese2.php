                        ...
                        <table width='98%' align='center' border='0' cellpadding='1' cellspacing='2' bgcolor='#f1f1f1' style='border-collapse: collapse; border: 1px solid #999;'>  
                            ...
                            <tr style="height: 30px">
                                ...
                                ?>
                                    ...
                                    <td class="Inpt">
                                    <input type='date' class='cinput'  name='Fechan' value='<?= $Fechan ?>' disabled> </input> ó 
                                     Edad : 
                                    <input type='text' class='cinput'  name='Anos' value='<?= $anos2 ?>' size='3'></input> Años
                                    </td>
                                <?php        
                                    }else{
                                ?>
                                    ...
                                    <input type='date' class='cinput'  name='Fechan' value='<?= $Fechan ?>'> </input> ó 
                                    <input class='Inpt' type='submit' name='Edad2' value='Edad'></input>
                                    <input type='text' class='cinput'  name='Anos' value='<?= $anos2 ?>' size='3' disabled></input> Años
                                    </td>
                                <?php
                                    }
                                ?>
